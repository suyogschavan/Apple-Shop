...
Partial Public Class StoreDataSet
    ...
    Partial Public Class OrdersDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddOrdersRow(ByVal Product_Name As String, ByVal Finish As String, ByVal Size As String, ByVal Memory As String, ByVal Storage As String, ByVal Price As Integer, ByVal User_ID As Integer) As OrdersRow
            Dim rowOrdersRow As OrdersRow = CType(Me.NewRow,OrdersRow)
            Dim columnValuesArray() As Object = New Object() {Product_Name, Finish, Size, Memory, Storage, Price, User_ID}
    ...
    Partial Public Class OrdersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Orders] ([Product_Name], [Finish], [Size], [Memory], [Storage]"& _ 
                ", [Price], [User_ID]) VALUES (@Product_Name, @Finish, @Size, @Memory, @Storage, "& _ 
                "@Price, @User_ID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Product_Name, Finish, Size, Memory, Storage, Price, User_ID FROM dbo.Order"& _ 
                "s"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As StoreDataSet.OrdersDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As StoreDataSet.OrdersDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As StoreDataSet.OrdersDataTable = New StoreDataSet.OrdersDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As StoreDataSet.OrdersDataTable) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Product_Name As String, ByVal Finish As String, ByVal Size As String, ByVal Memory As String, ByVal Storage As String, ByVal Price As Global.System.Nullable(Of Integer), ByVal User_ID As Integer) As Integer
            ...
            End If
            Me.Adapter.InsertCommand.Parameters(6).Value = CType(User_ID,Integer)
